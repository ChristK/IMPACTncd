...
.input.fn.dialog = list(
  ...
  #long.running = TRUE,
  yearstoproject.rangeItem = c(value=35L, from=1L, to=60L, by=1L), 
  label = "Forecast horizon",
  numberofiterations.integerItem = c(value=30L, from=1L, to=1000L, by=1L),
  label = "Define number of iterations", 
  diseasestoexclude.variableSelectorItem =  c("CHD", "Stroke", "Lung cancer", "Gastric cancer"),# "Gastric cancer"),
  label = "Define diseases to be included in the simulation",
  n.integerItem = c(value=4e5L, from=1e5L, to=2e6L, by=1e5L),
  ...
  signal = c("default", "toggle.sensitive", "widesynthpop"),
  signal = c("default", "toggle.sensitive", "process.output"),
  signal = c("default", "toggle.sensitive", "export.graphs"),
  
  
  fatality.annual.improvement.chd.rangeItem = c(value=5, from=0, to=10, by=0.1),
  label = "Assumption about annual percentage\nimprovement in CHD fatality",
  fatality.annual.improvement.stroke.rangeItem = c(value=5, from=0, to=10, by=0.1),
  ...
  BREAK = T,
  fatality.sec.gradient.chd.rangeItem = c(value=35, from=-100, to=100, by=10L),
  ...
  fatality.sec.gradient.stroke.rangeItem = c(value=30, from=-100, to=100, by=10L),
  ...
  fatality.sec.gradient.c34.rangeItem = c(value=30, from=-100, to=100, by=10L),
  ...
  widesynthpop.trueFalseItem = FALSE,
  label = "050607",
