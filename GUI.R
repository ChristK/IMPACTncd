...
.input.fn.dialog = list(
  ...
  #long.running = TRUE,
  yearstoproject.rangeItem = c(value=20L, from=1L, to=60L, by=1L), 
  label = "Forecast horizon",
  numberofiterations.integerItem = c(value=100L, from=1L, to=1000L, by=1L),
  ...
  n.integerItem = c(value=400000L, from=100000L, to=2000000L, by=100000L),
  ...
  init.year.choiceItem = c(2011, 2006),
