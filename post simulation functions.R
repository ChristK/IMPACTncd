...
MC.mean <- function(m, sd, n, lim = Inf,...) {
  sd[is.na(sd)] <- 2 * m # if mean of one value then sd is technically NA. This is an assumption sd =2*m
  m <- rtruncnorm(n, 0, lim, m, sd) # gives warning for m == NA. truncnorm doesn't
  return(
    list
    (mean = mean(m, na.rm = T, trim = 0.05),
...
closure.table.cat <- function (dt, type, rf, lagtime = c("no", "cvd", "ca"), ...) {
  rf <- substitute(rf)
  dt2 <- NULL
  
  if (lagtime == "no")  grp  <- c("year", "scenario")
  if (lagtime == "cvd") grp  <- c("year.cvdlag", "scenario")
  if (lagtime == "ca")  grp  <- c("year.calag", "scenario")
  ...
  # for type == "P" grp is fine. do not add sex to grp
...
closure.table.cont <- function (dt, type, rf.m, rf.sd, lagtime = c("no", "cvd", "ca"), ...) {
...
for (type in c("S", "SQ", "SA", "SAQ", "P")) {
  ...
  if ("C34" %in% diseasestoexclude) {
    Graphs.fn[[paste0("c34incid.", type)]] <- 
      closure.graph.cat(c34.burden,
                        type,
                        c34.incidence, 
                        0,
                        "Incidence",
    ...
    Graphs.fn[[paste0("c34incid.", type, ".WHO" )]] <- 
      closure.graph.std(c34.burden,
                        type,
                        c34.incidence, 
                        0,
                        "Incidence",
    ...
    Graphs.fn[[paste0("c34incid.", type, ".ESP" )]] <- 
      closure.graph.std(c34.burden,
                        type,
                        c34.incidence, 
                        0,
    ...
    Graphs.fn[[paste0("c34preval.", type)]] <-
      closure.graph.cat(c34.burden,
                        type,
                        c34.prevalence, 
                        0,
    ...
    Graphs.fn[[paste0("c34preval.", type, ".WHO" )]] <- 
      closure.graph.std(c34.burden,
                        type,
                        c34.prevalence, 
                        0,
    ...
    Graphs.fn[[paste0("c34preval.", type, ".ESP" )]] <- 
      closure.graph.std(c34.burden,
                        type,
                        c34.prevalence, 
                        0,
    ...
    Graphs.fn[[paste0("c34mortal.", type)]] <- 
      closure.graph.cat(c34.burden,
                        type,
                        c34.mortality, 
                        0,
    ...
    Graphs.fn[[paste0("c34mortal.", type, ".WHO" )]] <- 
      closure.graph.std(c34.burden,
                        type,
                        c34.mortality, 
                        0,
    ...
    Graphs.fn[[paste0("c34mortal.", type, ".ESP" )]] <- 
      closure.graph.std(c34.burden,
                        type,
                        c34.mortality, 
                        0,
    ...
    # if (type == "S") {
    #   Graphs.fn[[paste0("c34incid.SII.", type)]] <- 
    #     closure.graph.SII(c34.burden[group=="SQ"],
    #                       c34.incidence,
    #                       "Lung ca incidence",
    #                       F
    #     )
    #   Graphs.fn[[paste0("c34preval.SII.", type)]] <- 
    #     closure.graph.SII(c34.burden[group=="SQ"],
    #                       c34.prevalence,
    #                       "Lung ca prevalence",
    #                       F
    #     )
    #   Graphs.fn[[paste0("c34mortal.SII.", type)]] <- 
    #     closure.graph.SII(c34.burden[group=="SQ"],
    #                       c34.mortality,
    #                       "Lung ca mortality",
    #                       F
    #     )
    #   Graphs.fn[[paste0("c34incid.RII.", type)]] <-
    #     closure.graph.RII(c34.burden[group=="SQ"],
    #                       c34.incidence,
    #                       "Lung ca incidence",
    #                       F
    #     )
    #   Graphs.fn[[paste0("c34preval.RII.", type)]] <- 
    #     closure.graph.RII(c34.burden[group=="SQ"],
    #                       c34.prevalence,
    #                       "Lung ca prevalence",
    #                       F
    #     )
    #   Graphs.fn[[paste0("c34mortal.RII.", type)]] <-
    #     closure.graph.RII(c34.burden[group=="SQ"],
    #                       c34.mortality,
    #                       "Lung ca mortality",
    #                       F
    #     )
    #   Graphs.fn[[paste0("c34incid.SII.adj.", type)]] <- 
    #     closure.graph.SII(c34.burden[group=="SAQ"],
    #                       c34.incidence,
    #                       "Lung ca incidence (age adjusted)",
    #                       T
    #     )
    #   Graphs.fn[[paste0("c34preval.SII.adj.", type)]] <-
    #     closure.graph.SII(c34.burden[group=="SAQ"],
    #                       c34.prevalence,
    #                       "Lung ca prevalence (age adjusted)",
    #                       T
    #     )
    #   Graphs.fn[[paste0("c34mortal.SII.adj.", type)]] <-
    #     closure.graph.SII(c34.burden[group=="SAQ"],
    #                       c34.mortality,
    #                       "Lung ca mortality (age adjusted)",
    #                       T
    #     )
    #   Graphs.fn[[paste0("c34incid.RII.adj.", type)]] <-
    #     closure.graph.RII(c34.burden[group=="SAQ"],
    #                       c34.incidence,
    #                       "Lung ca incidence (age adjusted)",
    #                       T
    #     )
    #   Graphs.fn[[paste0("c34preval.RII.adj.", type)]] <-
    #     closure.graph.RII(c34.burden[group=="SAQ"],
    #                       c34.prevalence,
    #                       "Lung ca prevalence (age adjusted)",
    #                       T
    #     )
    #   Graphs.fn[[paste0("c34mortal.RII.adj.", type)]] <- 
    #     closure.graph.RII(c34.burden[group=="SAQ"],
    #                       c34.mortality,
    #                       "Lung ca mortality (age adjusted)",
    #                       T
...
for (type in c("S", "SQ", "SA", "SAQ", "P")) {
  # Risk Factors
  Tables.fn[[paste0("smoking.cvd.", type)]] <- 
  ...
  Tables.fn[[paste0("nev.smoking.cvd.", type)]] <- 
    closure.table.cat(riskfactors,
                      type,
                      smok.cvd.never, 
                      "cvd",
                      0,
                      "Prevalence",
                      "Never Smoking Prevalence"
    )
  # Risk Factors
  Tables.fn[[paste0("smoking.curr.", type)]] <- 
    closure.table.cat(riskfactors,
                      type,
                      smok.curr.active, 
                      "no",
                      0,
                      "Prevalence",
                      "Smoking Prevalence (nolag)"
    )
  Tables.fn[[paste0("nev.smoking.curr.", type)]] <- 
    closure.table.cat(riskfactors,
                      type,
                      smok.curr.never, 
                      "no",
                      0,
                      "Prevalence",
                      "Never Smoking Prevalence (nolag)"
    )
  Tables.fn[[paste0("packyears.", type)]] <- 
  ...
  Tables.fn[[paste0("packyears.cvd.", type)]] <- 
    closure.table.cont(riskfactors,
                       type,
                       packyears.cvd.mean, 
                       packyears.cvd.sd,
  ...
  if ("C34" %in% diseasestoexclude) {
    Tables.fn[[paste0("c34incid.", type)]] <-
      closure.table.cat(c34.burden,
                        type,
                        c34.incidence, 
                        "no",
                        0,
    ...
    Tables.fn[[paste0("c34preval.", type)]] <-
      closure.table.cat(c34.burden,
                        type,
                        c34.prevalence, 
                        "no",
    ...
    Tables.fn[[paste0("c34mortal.", type)]] <-
      closure.table.cat(c34.burden,
                        type,
                        c34.mortality, 
                        "no",
    ...
    # if (type == "S") {
    #   Tables.fn[[paste0("c34incid.SII.", type)]] <-
    #     closure.table.SII(c34.burden[group=="SQ"],
    #                       c34.incidence,
    #                       F
    #     )
    #   Tables.fn[[paste0("c34preval.SII.", type)]] <-
    #     closure.table.SII(c34.burden[group=="SQ"],
    #                       c34.prevalence,
    #                       F
    #     )
    #   Tables.fn[[paste0("c34mortal.SII.", type)]] <-
    #     closure.table.SII(c34.burden[group=="SQ"],
    #                       c34.mortality,
    #                       F
    #     )
    #   Tables.fn[[paste0("c34incid.RII.", type)]] <- 
    #     closure.table.RII(c34.burden[group=="SQ"],
    #                       c34.incidence,
    #                       F
    #     )
    #   Tables.fn[[paste0("c34preval.RII.", type)]] <-
    #     closure.table.RII(c34.burden[group=="SQ"],
    #                       c34.prevalence,
    #                       F
    #     )
    #   Tables.fn[[paste0("c34mortal.RII.", type)]] <- 
    #     closure.table.RII(c34.burden[group=="SQ"],
    #                       c34.mortality,
    #                       F
    #     )
    #   Tables.fn[[paste0("c34incid.SII.adj.", type)]] <- 
    #     closure.table.SII(c34.burden[group=="SAQ"],
    #                       c34.incidence,
    #                       T
    #     )
    #   Tables.fn[[paste0("c34preval.SII.adj.", type)]] <- 
    #     closure.table.SII(c34.burden[group=="SAQ"],
    #                       c34.prevalence,
    #                       T
    #     )
    #   Tables.fn[[paste0("c34mortal.SII.adj.", type)]] <-
    #     closure.table.SII(c34.burden[group=="SAQ"],
    #                       c34.mortality,
    #                       T
    #     )
    #   Tables.fn[[paste0("c34incid.RII.adj.", type)]] <-
    #     closure.table.RII(c34.burden[group=="SAQ"],
    #                       c34.incidence,
    #                       T
    #     )
    #   Tables.fn[[paste0("c34preval.RII.adj.", type)]] <- 
    #     closure.table.RII(c34.burden[group=="SAQ"],
    #                       c34.prevalence,
    #                       T
    #     )
    #   Tables.fn[[paste0("c34mortal.RII.adj.", type)]] <-
    #     closure.table.RII(c34.burden[group=="SAQ"],
    #                       c34.mortality,
    #                       T
    #     )
...
GraphsfromTables <- cmpfun(
  function(x) {
    ...
    if (grepl(glob2rx("nev.smoking*"), x)) {
      title <- "Never smoking prevalence"
      yaxis <- "Prevalence"
      yscale <- 1
      pct <- T
    } 
    if (grepl(glob2rx("packyears*"), x)) {
      title <- "Packyears"
      yaxis <- "Mean packyears"
      yscale <- 1
      pct <- F
    }
    ...
    #   age.lim <- F
    # } 
    if (grepl(glob2rx("c34incid.*"), x)) {
      title <- "Lung ca incidence"
      yaxis <- "Incidence"
      yscale <- 100000
      pct <- F
      age.lim <- T
    } 
    if (grepl(glob2rx("c34preval.*"), x)) {
      title <- "Lung ca prevalence"
      yaxis <- "Prevalence"
      yscale <- 100000
      pct <- F
      age.lim <- T
    } 
    if (grepl(glob2rx("c34mortal.*"), x)) {
      title <- "Lung ca mortality"
      yaxis <- "Mortality"
      yscale <- 100000
      pct <- F
      age.lim <- T
    } 
    # if (grepl(glob2rx("c34incid.SII.S*"), x)) {
    #   title <- "Absolute inequality in lung ca incidence"
    #   yaxis <- "Slope index of inequality"
    #   yscale <- 1
    #   pct <- F
    #   age.lim <- F
    # } 
    # if (grepl(glob2rx("c34preval.SII.S*"), x)) {
    #   title <- "Absolute inequality in lung ca prevalence"
    #   yaxis <- "Slope index of inequality"
    #   yscale <- 1
    #   pct <- F
    #   age.lim <- F
    # } 
    # if (grepl(glob2rx("c34mortal.SII.S*"), x)) {
    #   title <- "Absolute inequality in lung ca mortality"
    #   yaxis <- "Slope index of inequality"
    #   yscale <- 1
    #   pct <- F
    #   age.lim <- F
    # } 
    # if (grepl(glob2rx("c34incid.RII.S*"), x)) {
    #   title <- "Relative inequality in lung ca incidence"
    #   yaxis <- "Relative  index of inequality"
    #   yscale <- 1
    #   pct <- F
    #   age.lim <- F
    # } 
    # if (grepl(glob2rx("c34preval.RII.S*"), x)) {
    #   title <- "Relative inequality in lung ca prevalence"
    #   yaxis <- "Relative index of inequality"
    #   yscale <- 1
    #   pct <- F
    #   age.lim <- F
    # } 
    # if (grepl(glob2rx("c34mortal.RII.S*"), x)) {
    #   title <- "Relative inequality in lung ca mortality"
    #   yaxis <- "Relative index of inequality"
    #   yscale <- 1
    #   pct <- F
    #   age.lim <- F
    # } 
    # if (grepl(glob2rx("c34incid.SII.a*"), x)) {
    #   title <- "Absolute inequality in lung ca incidence (age adjusted)"
    #   yaxis <- "Slope index of inequality"
    #   yscale <- 1
    #   pct <- F
    #   age.lim <- F
    # } 
    # if (grepl(glob2rx("c34preval.SII.a*"), x)) {
    #   title <- "Absolute inequality in lung ca prevalence (age adjusted)"
    #   yaxis <- "Slope index of inequality"
    #   yscale <- 1
    #   pct <- F
    #   age.lim <- F
    # } 
    # if (grepl(glob2rx("c34mortal.SII.a*"), x)) {
    #   title <- "Absolute inequality in lung ca mortality (age adjusted)"
    #   yaxis <- "Slope index of inequality"
    #   yscale <- 1
    #   pct <- F
    #   age.lim <- F
    # } 
    # if (grepl(glob2rx("c34incid.RII.a*"), x)) {
    #   title <- "Relative inequality in lung ca incidence (age adjusted)"
    #   yaxis <- "Relative index of inequality"
    #   yscale <- 1
    #   pct <- F
    #   age.lim <- F
    # } 
    # if (grepl(glob2rx("c34preval.RII.a*"), x)) {
    #   title <- "Relative inequality in lung ca prevalence (age adjusted)"
    #   yaxis <- "Relative index of inequality"
    #   yscale <- 1
    #   pct <- F
    #   age.lim <- F
    # } 
    # if (grepl(glob2rx("c34mortal.RII.a*"), x)) {
    #   title <- "Relative inequality in lung ca mortality (age adjusted)"
    #   yaxis <- "Relative index of inequality"
    #   yscale <- 1
    #   pct <- F
    #   age.lim <- F
    ...
    if (length(grep("mean", names(dt))) > 0 &
        length(grep(glob2rx("*le*.*"), x)) == 0) {
      dt[, `:=` (mean = yscale * mean,
                 lui  = yscale * lui,
                 uui  = yscale * uui)]
    }
    ...
    if ("year.cvdlag" %in% names(dt)) dt[, year := year.cvdlag]
    if ("year.calag" %in% names(dt)) dt[, year := year.calag]
    ...
    g <- ggplot(dt,
      ...
      geom_errorbar(aes(ymin= lui, ymax = uui),
                    ...
                    position = pd,
                    alpha = 3/5) +
      geom_line(position = pd, size = 0.5, alpha = 4/4) +
