...
gg <-
  ggplot(tt[between(year, 2006, 2018), ],
         aes(x = year, y = salt, 
  ...
  scale_x_continuous(name = "Year", breaks = c(2010, 2018)) +
...
cowplot::ggsave("salt_scenarios2018.tiff", gg, path = save_dir, dpi = 600,
...
fwrite(ext(2018, NULL), paste0(save_dir, "results_2018.csv"))
# fwrite(ext(2025, NULL), paste0(save_dir, "results_2025.csv"))

fwrite(ext(2018, "qimd"), paste0(save_dir, "results_2018_qimd.csv"))
...
# 50% 25% 75% 
# 71  16 130 
fwrite(res, paste0(save_dir, "costs_2018.csv"))
